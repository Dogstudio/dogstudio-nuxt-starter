      ...
      preprocessorOptions: {
        scss: {
          additionalData: `
            ...
            @use "~/styles/vendors/sass-mq/_mq.scss";
            @use "~/styles/utils/_utilities.scss";
            @use "~/styles/utils/_easings.scss";
            @use "~/styles/utils/_variables.scss";
            @use "~/styles/utils/_functions.scss";
          `,
        },
      },
    },
